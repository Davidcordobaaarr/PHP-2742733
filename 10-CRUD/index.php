...
<body class="fondo_index">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" style="margin-bottom: 30px;">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="./img/juegos2.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="./img/juegos3.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="./img/juegos4.jpg" class="d-block w-100" alt="...">
                </div>
            </div>
    ...
    <div class="container">
        ...
        <button class="boton" link="curso.php" type="button" ><a href="./curso.php">Administra tus cursos</a></button>

        </div>
    </div>

    </div>
    <div class="container text-center fondo_control" style="margin-top: 30px;">
        <div class="row align-items-center">
            <div class="col">

                <h1>Cursos de desarrollo de<br> videojuegos</h1>
            ...
            <div class="col" style="padding: 20px;">
                <img class="control" src="./img/juegos1.jpg" alt="">
            </div>
        </div>
    </div>  
